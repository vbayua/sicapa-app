...
<div x-data="{ show: false }" class="inline-block">
    ...
    <div x-show="show" style="display: none;"
        ...
        <div class="relative overflow-auto bg-white p-8 space-y-6 rounded-lg w-3/4 shadow-lg"
            @click.outside="show=false">
            <div class="absolute top-0 right-0 py-3 px-3 cursor-pointer"
                @click="show = false">
            ...
            <div>
                ...
                <p>
                    Pada saat penyusunan Compaby Profile tidak mengikuti prosedur yang
                    terdapat pada POB #HRD-001-00 (Prosedur Penyusunan Company Profile PT.
                    Imperial Kosmetika Indonesia)
                </p>
            </div>
        </div>
    </div>
